"""A hello-world filter plugin in ${{ values.collectionNamespace }}.${{ values.collectionName }}."""
...
DOCUMENTATION = """
    name: hello_world
    author: ${{ values.collectionNamespace }} ${{ values.collectionName }}
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | ${{ values.collectionNamespace }}.${{ values.collectionName }}.hello_world }}"
"""
